...
/*
Uncomment to use local bootstrap styles
*/
...
function mat_assets() {
	wp_enqueue_style( 'nudge-theme', get_stylesheet_uri() );
}
...
function theme_styles() {
    ...
    // wp_enque_style('googlefonts_css', '//fonts.googleapis.com/css?family=Lato');
    // wp_enque_style('fontawesome_css', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css"');
}
...
function theme_js() {
	...
	wp_enqueue_script( 'jquery_js', '//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js');
	wp_enqueue_script( 'bootstrap_js', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js');
    // wp_enque_script( 'fontawesome_js', '//use.fontawesome.com/f9ba6b20c2.js');
